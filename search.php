...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="#">
    ...
    <?php
        echo "  Search result for " , $search_a;
    ?>
  </a>
...
if(isset($_POST['search_b'])){
  ...
  //echo $search_a;
        ...
        $sql="SELECT * FROM book WHERE book_type = '$search_a' or city = '$search_a' or gender = '$search_a' or username_1  = '$search_a' " ;
        //echo $search_a;
...
<div class="hide">
  <p>Name: <?php echo $row["name"]; ?></p>
        ...
        <p>City: <?php echo $row["city"]; ?></p>
					<p>Book Type: <?php echo $row["book_type"]; ?></p>
					<p>Description: <?php echo $row["description"]; ?></p></div>
<br>
    <p> </p>
      </div>
    </div>
